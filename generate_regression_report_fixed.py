#!/usr/bin/env python
"""
DEPRECATED: This file has been moved to src/generate_regression_report_fixed.py
...
Example usage:
    python generate_regression_report_fixed.py --version_dir data/processed/regression_results/v1
...
# Add the src directory to sys.path to correctly import the package
